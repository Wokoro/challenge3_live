...
var targetController = require('./api/target')
const { runScheduleTasks } = require('./utils')
...
router.set('/api/targets', { POST: targetController.createTarget, GET: targetController.getAllTargets })
router.set('/api/target/:id', { GET: targetController.getTarget, POST: targetController.updateTarget })
router.set('/api/route', { POST: targetController.requestPost })

module.exports = function createServer () {
  runScheduleTasks(scheduledTasks)
